...
Building:
    ...
    - Unbuild previous xspublic from your ament workspace:
        $ pushd src/bluespace_ai_xsens_ros_mti_driver/lib/xspublic && make clean && popd
